...
class ProviderAuthenticationError(ProviderError, SourceAuthenticationError):
...
class ProviderTimeoutError(ProviderError, SourceTransientError):
...
class ProviderUnavailableError(ProviderError, SourceTransientError):
...
class ProviderRateLimitError(ProviderError, SourceTransientError):
